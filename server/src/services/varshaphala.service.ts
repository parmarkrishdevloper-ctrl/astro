...
export const SAHAM_DEFS: SahamDef[] = [
  { key: 'punya',     name: 'पुण्य साहम',     formula: 'Moon - Sun + Lagna' },
  { key: 'vidya',     name: 'विद्या साहम',     formula: 'Sun - Moon + Lagna' },
  { key: 'yasas',     name: 'यश साहम',     formula: 'Jupiter - Punya + Lagna' },
  { key: 'mitra',     name: 'मित्र साहम',     formula: 'Jupiter - Punya + Venus' },
  { key: 'mahatmya',  name: 'माहात्म्य साहम',  formula: 'Saturn - Mars + Lagna' },
  { key: 'asha',      name: 'आशा साहम',      formula: 'Saturn - Mars + Lagna (day) / reverse (night)' },
  { key: 'samartha',  name: 'समर्थ साहम',  formula: 'Mars - Lagna lord + Lagna' },
  { key: 'gnati',     name: 'ज्ञाति साहम',     formula: 'Saturn - Lagna lord + Lagna' },
  { key: 'gaurava',   name: 'गौरव साहम',   formula: 'Jupiter - Sun + Lagna' },
  { key: 'pitri',     name: 'पितृ साहम',     formula: 'Saturn - Sun + Lagna' },
  { key: 'rajya',     name: 'राज्य साहम',     formula: 'Saturn - Sun + Lagna' },
  { key: 'putra',     name: 'पुत्र साहम',     formula: 'Jupiter - Moon + Lagna' },
  { key: 'jeeva',     name: 'जीव साहम',     formula: 'Saturn - Jupiter + Lagna' },
  { key: 'karma',     name: 'कर्म साहम',     formula: 'Mars - Mercury + Lagna' },
  { key: 'roga',      name: 'रोग साहम',      formula: 'Lagna - Moon + Lagna' },
  { key: 'kali',      name: 'कलि साहम',      formula: 'Jupiter - Mars + Lagna' },
  // ─── Phase 14J expansion — Tajika sahams from Yavanajataka / Tajaka-Neelakanthi ───
  { key: 'artha',     name: 'अर्थ साहम',     formula: '2nd cusp - 2nd lord + Lagna' },
  { key: 'dharma',    name: 'धर्म साहम',    formula: 'Moon - Sun + Lagna (day); reversed at night' },
  { key: 'bhratri',   name: 'भ्रातृ साहम',   formula: 'Jupiter - Saturn + Lagna' },
  { key: 'matri',     name: 'मातृ साहम',     formula: 'Moon - Venus + Lagna' },
  { key: 'vivaha',    name: 'विवाह साहम',    formula: 'Venus - Saturn + Lagna' },
  { key: 'paradesa',  name: 'परदेश साहम',  formula: '9th cusp - 9th lord + Lagna' },
  { key: 'shubha',    name: 'शुभ साहम',    formula: 'Venus - Saturn + Lagna' },
  { key: 'pavitra',   name: 'पवित्र साहम',   formula: 'Jupiter - Sun + Lagna' },
  { key: 'kosha',     name: 'कोश साहम',     formula: '2nd lord - 2nd cusp + Lagna' },
  { key: 'bandhana',  name: 'बंधन साहम',  formula: 'Gulika - Saturn + Lagna' },
  { key: 'satru',     name: 'शत्रु साहम',     formula: '6th lord - Mars + Lagna' },
  { key: 'anya',      name: 'अन्यकर्म साहम', formula: 'Saturn - Moon + Lagna' },
  { key: 'mrityu',    name: 'मृत्यु साहम',    formula: '8th cusp - Moon + Lagna' },
  { key: 'videsh',    name: 'विदेशगमन साहम',    formula: '12th lord - 12th cusp + Lagna' },
  { key: 'apamrtyu',  name: 'अपमृत्यु साहम', formula: 'Mars - 8th lord + Lagna' },
  { key: 'hari',      name: 'हरि साहम',      formula: '12th cusp - 12th lord + Lagna' },
  { key: 'harsha',    name: 'हर्ष साहम',    formula: '11th cusp - 11th lord + Lagna' },
  { key: 'dukkha',    name: 'दुःख साहम',     formula: 'Lagna lord - Mars + Lagna' },
  { key: 'sukha',     name: 'सुख साहम',     formula: '4th cusp - Moon + Lagna' },
  { key: 'moksha',    name: 'मोक्ष साहम',    formula: '12th cusp - Saturn + Lagna' },
  { key: 'shakti',    name: 'शक्ति साहम',    formula: 'Mars - Saturn + Lagna' },
  { key: 'marana',    name: 'मरण साहम',    formula: '8th cusp - 8th lord + Lagna' },
  { key: 'adhyatma',  name: 'अध्यात्म साहम',  formula: 'Jupiter - Saturn + Lagna' },
  { key: 'labha',     name: 'लाभ साहम',     formula: '11th cusp - 11th lord + Lagna' },
  { key: 'santan',    name: 'संतान साहम',    formula: 'Jupiter - Saturn + Lagna' },
  { key: 'kama',      name: 'काम साहम',      formula: 'Venus - Sun + Lagna' },
  { key: 'chandra',   name: 'चंद्र साहम',   formula: 'Moon - Saturn + Lagna' },
  { key: 'mahima',    name: 'महिमा साहम',    formula: 'Mars - Sun + Lagna' },
  { key: 'samudra',   name: 'समुद्र साहम',   formula: 'Moon - Mars + Lagna' },
  { key: 'guru',      name: 'गुरु साहम',      formula: 'Jupiter - Venus + Lagna' },
  { key: 'surya',     name: 'सूर्य साहम',     formula: 'Sun - Saturn + Lagna' },
  { key: 'tapasa',    name: 'तपस साहम',    formula: 'Saturn - Jupiter + Lagna' },
  { key: 'artha_sp',  name: 'अर्थ स्फुट',    formula: 'Jupiter - Mars + Lagna' },
  { key: 'vanija',    name: 'वाणिज्य साहम',    formula: 'Mercury - Jupiter + Lagna' },
];
