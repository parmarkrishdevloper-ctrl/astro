...
export const VARGA_META: Record<Varga, VargaMeta> = {
  D1:  { varga: 'D1',  name: 'Rasi',             nameHi: 'राशि',            segments: 1,  segmentDeg: 30,     purpose: 'जन्म कुंडली — समग्र जीवन' },
  D2:  { varga: 'D2',  name: 'Hora',             nameHi: 'होरा',            segments: 2,  segmentDeg: 15,     purpose: 'धन, समृद्धि' },
  D3:  { varga: 'D3',  name: 'Drekkana',         nameHi: 'द्रेक्काण',        segments: 3,  segmentDeg: 10,     purpose: 'भाई-बहन, साहस, प्रयास' },
  D4:  { varga: 'D4',  name: 'Chaturthamsa',     nameHi: 'चतुर्थांश',        segments: 4,  segmentDeg: 7.5,    purpose: 'भाग्य, संपत्ति, अचल संपत्ति' },
  D5:  { varga: 'D5',  name: 'Panchamsa',        nameHi: 'पंचमांश',          segments: 5,  segmentDeg: 6,      purpose: 'शक्ति, अधिकार, प्रसिद्धि' },
  D6:  { varga: 'D6',  name: 'Shashthamsa',      nameHi: 'षष्ठांश',          segments: 6,  segmentDeg: 5,      purpose: 'शत्रु, रोग, मुकदमेबाजी' },
  D7:  { varga: 'D7',  name: 'Saptamsa',         nameHi: 'सप्तांश',          segments: 7,  segmentDeg: 30/7,   purpose: 'संतान, संतति' },
  D8:  { varga: 'D8',  name: 'Ashtamsa',         nameHi: 'अष्टांश',          segments: 8,  segmentDeg: 3.75,   purpose: 'आयु, आकस्मिक घटनाएँ, गुप्त विद्या' },
  D9:  { varga: 'D9',  name: 'Navamsa',          nameHi: 'नवांश',            segments: 9,  segmentDeg: 30/9,   purpose: 'जीवनसाथी, धर्म, जीवन का उत्तरार्ध' },
  D10: { varga: 'D10', name: 'Dasamsa',          nameHi: 'दशमांश',           segments: 10, segmentDeg: 3,      purpose: 'करियर, स्थिति, पेशा' },
  D11: { varga: 'D11', name: 'Rudramsa',         nameHi: 'रुद्रांश',         segments: 11, segmentDeg: 30/11,  purpose: 'विनाश, हानि, उथल-पुथल' },
  D12: { varga: 'D12', name: 'Dwadasamsa',       nameHi: 'द्वादशांश',        segments: 12, segmentDeg: 2.5,    purpose: 'माता-पिता, वंश, पैतृक कर्म' },
  D16: { varga: 'D16', name: 'Shodasamsa',       nameHi: 'षोडशांश',          segments: 16, segmentDeg: 30/16,  purpose: 'वाहन, सुख-सुविधाएँ, विलासिता (कलत्र)' },
  D20: { varga: 'D20', name: 'Vimsamsa',         nameHi: 'विंशांश',          segments: 20, segmentDeg: 1.5,    purpose: 'आध्यात्मिक अभ्यास, उपासना' },
  D24: { varga: 'D24', name: 'Chaturvimsamsa',   nameHi: 'चतुर्विंशांश',     segments: 24, segmentDeg: 1.25,   purpose: 'शिक्षा, ज्ञान, सिद्धि' },
  D27: { varga: 'D27', name: 'Bhamsa/Nakshatramsa', nameHi: 'भांश',         segments: 27, segmentDeg: 30/27,  purpose: 'बल, दुर्बलता, सहनशक्ति' },
  D30: { varga: 'D30', name: 'Trimsamsa',        nameHi: 'त्रिंशांश',         segments: 30, segmentDeg: 1,      purpose: 'दुर्भाग्य, बुराइयाँ, अरिष्ट' },
  D40: { varga: 'D40', name: 'Khavedamsa',       nameHi: 'खवेदांश',          segments: 40, segmentDeg: 0.75,   purpose: 'शुभ/अशुभ प्रभाव (मातृ)' },
  D45: { varga: 'D45', name: 'Akshavedamsa',     nameHi: 'अक्षवेदांश',       segments: 45, segmentDeg: 30/45,  purpose: 'सामान्य संकेत (पितृ)' },
  D60: { varga: 'D60', name: 'Shashtiamsa',      nameHi: 'षष्ठ्यांश',        segments: 60, segmentDeg: 0.5,    purpose: 'पूर्व जन्म के कर्म, सूक्ष्मतम कुण्डली' },
};
